...
- **"Create Expense Report"** is now the hero button at the top
- Gradient background (blue)
- Large with icon and arrow
- Hover effects (scale, shadow)
- Mobile responsive
- Links to `/reports/new` (we'll build this next)

### **✅ Quick Actions - Smaller Cards:**
- "My Reports" - View/manage reports
- "My Receipts" - View receipts archive (read-only)
- "Analytics" - Future feature

### **✅ Role-Specific Buttons:**
- "Review Reports" (accounting/admin only)
- "Admin Panel" (admin only)

### **✅ Quick Stats:**
- Placeholder cards for future dynamic data
- Total receipts, pending reports, total spent

### **✅ Removed:**
- ❌ "Upload Receipt" as primary action
- Now receipts are uploaded within expense reports
...
│                                                 │
│  ╔═══════════════════════════════════════════╗ │
│  ║  📋 CREATE EXPENSE REPORT                 ║ │  <-- BIG!
│  ║  Start a new expense report and upload... ║ │
│  ╚═══════════════════════════════════════════╝ │
│                                                 │
├─────────────────────────────────────────────────┤
│  Quick Actions:                                 │
│  [My Reports]  [My Receipts]  [Analytics]      │
├─────────────────────────────────────────────────┤
│  [Review Reports (accounting)]                  │
│  [Admin Panel (admin)]                          │
├─────────────────────────────────────────────────┤
│  Stats: [Total Receipts] [Pending] [Spent]     │
└─────────────────────────────────────────────────┘

        ...
        <div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4">
            ...
            <div className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              <p>Uploaded: {new Date(receipt.uploaded_at).toLocaleString()}</p>
              <p>Source: {receipt.upload_source}</p>
              <p>Status: <span className="font-medium capitalize">{receipt.status}</span></p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          {expense ? (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6 space-y-6">
              ...
              {/* AI Confidence */}
              {expense.extracted_data?.confidence && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    AI Confidence
                  </label>
